  ...
  mini: {
    ...
    ui: {
      ...
      upgrade: {
        ...
        ctaBody: 'Între timp, intră gratuit în grupul nostru de WhatsApp — sfaturi zilnice, suport și comunitate.',
        ctaButton: 'Intră în grupul CYB gratuit →',
        ctaWhatsApp: 'https://chat.whatsapp.com/Gyi1jBE4lI5JQZKTJ9jxsC',
      },
    },
  },
  ...
  complet: {
    ...
    ui: {
      ...
      results: {
        ...
        ctaBody: 'Intră în grupul nostru de WhatsApp și hai să construim împreună programul tău personalizat.',
