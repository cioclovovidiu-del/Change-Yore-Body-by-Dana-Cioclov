...
.ab__txt p{font-size:1.05rem;margin-bottom:1.5rem;max-width:520px;text-align:center}
.ab__txt{display:flex;flex-direction:column;align-items:center}
...
@media(min-width:768px){
  ...
  .ab__txt p{text-align:left}
  .ab__txt{align-items:flex-start}
}
