...
.hero__sub{font-size:clamp(1rem,2.5vw,1.2rem);opacity:.9;margin-bottom:2.2rem;font-weight:300}
...
.tl__x{font-weight:300;opacity:.9;padding-top:.15rem}
...
.qz__desc{opacity:.8;margin-bottom:1.5rem}
...
.man__txt p{font-family:var(--font-cormorant),Georgia,serif;font-style:italic;
  font-size:clamp(1.4rem,3.5vw,2.4rem);font-weight:400;margin-bottom:1rem;line-height:1.4;opacity:.9}
.man__txt p:last-child{opacity:1}
