...
export const EXERCISE_DB: Record<string, ExerciseDBEntry> = {
  ...
  'Marș pe loc':{displayName:'Mers pe loc',en:'March in Place',instr:'Menține un ritm constant, spatele drept, umerii relaxați.',media:{canonicalVideoId:'mers_pe_loc/front',angleFrontId:'mers_pe_loc/front',angleSideId:'mers_pe_loc/side',posterImageId:'mers_pe_loc/poster',loopSeconds:4}},
  ...
  'Planșă pe antebrațe':{displayName:'Planșă pe antebrațe',en:'Forearm Plank',instr:'Corp drept din cap până la călcâie. Abdomen contractat, respiră normal.',media:{canonicalVideoId:'plansa_antebrate/front',angleFrontId:'plansa_antebrate/front',angleSideId:'plansa_antebrate/side',posterImageId:'plansa_antebrate/poster',loopSeconds:4}},
